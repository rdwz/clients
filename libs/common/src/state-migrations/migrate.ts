...
import { RemoveRefreshTokenMigratedFlagMigrator } from "./migrations/57-remove-refresh-token-migrated-state-provider-flag";
...
export function createMigrationBuilder() {
  return MigrationBuilder.create()
    ...
    .with(RemoveRefreshTokenMigratedFlagMigrator, 56, CURRENT_VERSION);
}
