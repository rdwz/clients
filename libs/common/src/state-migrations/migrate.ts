...
import { VaultTimeoutSettingsServiceStateProviderMigrator } from "./migrations/56-migrate-vault-timeout-settings-svc-to-state-provider";
...
export function createMigrationBuilder() {
  return MigrationBuilder.create()
    ...
    .with(VaultTimeoutSettingsServiceStateProviderMigrator, 55, CURRENT_VERSION);
}
