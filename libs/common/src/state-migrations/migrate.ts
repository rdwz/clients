...
import { PinKeyEncryptedUserKeyMigrator } from "./migrations/50-move-pin-key-encrypted-user-key-to-state-providers";
...
export function createMigrationBuilder() {
  return MigrationBuilder.create()
    ...
    .with(PinKeyEncryptedUserKeyMigrator, 49, CURRENT_VERSION);
}
