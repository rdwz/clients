...
import { PinKeyEncryptedUserKeyMigrator } from "./migrations/49-move-pin-key-encrypted-user-key-to-state-providers";
...
export function createMigrationBuilder() {
  return MigrationBuilder.create()
    ...
    .with(PinKeyEncryptedUserKeyMigrator, 48, CURRENT_VERSION);
}
